...
urlpatterns = [
    ...
    path('dashboard/<str:object_id>/profile/', views.owner_profile, name='owner_profile'),
    path('dashboard/<str:object_id>/change_password/', views.owner_change_password, name='owner_change_password'),
